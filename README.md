![docker image](https://github.com/Sathya-S3/nomad-distro-template-test-test/actions/workflows/docker-publish.yml/badge.svg)


# Sathya-S3's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of Sathya-S3.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Sathya-S3/nomad-distro-template-test-test.git
    cd nomad-distro-template-test
    ```

    or

    ```sh
    curl-L -o nomad-distro-template-test.zip "https://github.com/Sathya-S3/nomad-distro-template-test-test/archive/main.zip"
    unzip nomad-distro-template-test.zip
    cd nomad-distro-template-test
    ```
...
your `docker-compose.yaml` with `ghcr.io/sathya-s3/nomad-distro-template-test-test:main` for the services
...
```sh
docker pull ghcr.io/sathya-s3/nomad-distro-template-test-test/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/Sathya-S3/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/Sathya-S3/nomad-docs/fork).
...
```sh
git remote add template https://github.com/FAIRmat-NFDI/nomad-distro-template-test
git fetch template
...
For detailed instructions on how to resolve the merge conflicts between different version we refer you to the latest template release [notes](https://github.com/Sathya-S3/nomad-distro-template-test-test/releases/latest)
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Sathya-S3/nomad-distro-template-test-test/manifests/main": unauthorized`
